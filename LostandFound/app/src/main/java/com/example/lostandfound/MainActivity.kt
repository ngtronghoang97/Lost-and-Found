...
import com.example.lostandfound.ui.ItemListFragment
import com.example.lostandfound.ui.RemoveFragment
import com.example.lostandfound.ui.StartFragment
...
class MainActivity : AppCompatActivity() {
    ...
    fun recordToDb(name:String, phone:String, description:String, date:String, location:String) {
        /**
